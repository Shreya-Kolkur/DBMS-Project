<?php 
   ...
   session_start();
    ...
    echo '<tr>
        ...
        <td>
        <button class="btn btn-primary"><a href="update_employee_password.php? update_id='.$employee_id.'" class="text-light">Change Password</a></button>
        </td>
        <td>
        <form method = "POST">
...
<html lang="en">
   ...
   <body>
      <section class="mt-3">
         ...
         <h1 class="text-center" style="color:green"> Grocery Store </h1>
         <h3 class="text-center"> Shivajinagar Pune</h3>
         <h6 class="text-center"><?php echo $employee_name; ?></h6>
                        ...
                        <td style="width:60%">
                           <select name="vegitable" id="vegitable"  class="form-control">
                              <?php 
                                 ...
                                 ?>
                              <option id="<?php echo $row['product_id']; ?>" value="<?php echo $row['name']; ?>" class="vegitable custom-select">
                                 <?php echo $row['name']; ?>
                              </option>
                              <?php  }?>   
                           </select>
          ...
          $('#new').append(table)
           ...
           // Code for Sub Total of Vegitables 
            ...
            // Code for calculate tax of Subtoal 5% Tax Applied
             ...
             $(document).ready(function () {
               createCookie("price", totalPayment);
              });
